...
public class EmployeeAdapters extends ArrayAdapter<Employee> {
    private Context mCtx;
    private int listLayoutRes;
    private List<Employee> employeeList;
    private SQLiteDatabase mDatabase;

    public EmployeeAdapters(Context mCtx, int listLayoutRes, List<Employee> employeeList, SQLiteDatabase mDatabase) {
